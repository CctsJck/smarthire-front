    ...
    return(
        ...
        <div>
            <div class='container bg-white rounded mt-5'>
                ...
                <p class='text-center text-body-secondary'>¡Hola! En esta plataforma es una nueva forma de ... Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam repellat officiis dolorum earum maxime culpa, ut nobis impedit eum perferendis optio accusamus at quisquam delectus maiores eius aspernatur quod inventore!</p>
                <div className="col-md-12 d-flex card shadow mt-5">
                    <div className="d-flex align-items-center">
                        <div className="col-md-9 text-center py-5">
                        <h3> Utiliza inteligencia artificial en para la deteccion de emociones</h3>
                        <p>
                ...
                <div class='d-flex justify-content-center mb-4 pb-4'>
                        <button onClick={() => navigate(`/candidate/sign/${params.idBusqueda}`)} className="btn btn-success mb-4">
                            Comenzar
                        </button>
                </div>
                <div></div>
